...
class Partials{
    ...
    public static function output_causes_grid_part( $args = null){
        ...
        $cols = $args['col'];
        $show_fund_icon = $args['show_fund_icon'];
        $grid = 12 / $cols;
                    ...
                    <div class="windzfare_causes_content">
                        ...
                        <div class="windzfare_progress_content">
                            ...
                            <div class="windzfare_progress_amount">
                                ...
                                <span><?php if($show_fund_icon == 1){ ?><i class="ion-md-wifi"></i><?php } ?> <b><?php esc_html_e( 'Goal:','windzfare' ); ?></b> <?php echo wc_price( $funding_goal ); ?></span> 
                                
                                <span><?php if($show_fund_icon == 1){ ?><i class="ion-logo-usd"></i><?php } ?> <b><?php esc_html_e( 'Raised:', 'windzfare' ); ?></b> <?php echo wc_price( $raised ); ?></span>
    ...
    public static function output_causes_grid_carousel_part( $args = null){
                ...
                <div class="windzfare_causes_wrapper">
                    ...
                    <div class="windzfare_causes_content">
                        ...
                        <div class="windzfare_progress_content">
                            ...
                            <div class="windzfare_progress_amount"><span><?php if($show_fund_icon == 1){ ?><i class="ion-md-wifi"></i><?php } ?> <b><?php esc_html_e( 'Goal:','windzfare' ); ?></b> <?php echo wc_price( $funding_goal ); ?></span> <span><?php if($show_fund_icon == 1){ ?><i class="ion-logo-usd"></i><?php } ?> <b><?php esc_html_e('Raised:', 'windzfare'); ?></b> <?php echo wc_price( $raised ); ?></span></div>
                        </div>
                    </div>
                    <div class="windzfare_button_group">
                        <a href="<?php the_permalink(); ?>" class="windzfare_button effect_1">
    ...
    public static function share($show_label='yes'){ ?>
        <div class="event_social">
            <?php if($show_label == 'yes'){ ?><h6><?php esc_html_e('Share:', 'windzfare'); ?></h6><?php } ?>
            <ul>
                <li class="facebook">
                    <a href="https://www.facebook.com/share.php?u=<?php the_permalink();?>"><i class="ion-logo-facebook"></i></a>
                </li>
                <li class="twitter">
                    <a href="http://twitter.com/intent/tweet?status=<?php the_title() ?>+<?php the_permalink();?>"><i class="ion-logo-twitter"></i></a>
                </li>
                <li class="linkedin">
                    <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo the_permalink(); ?>&title=<?php the_title(); ?>&source=<?php echo home_url('/');?>"><i class="ion-logo-linkedin"></i></a>
                </li>
                <li class="pinterest">
                    <a href="http://pinterest.com/pin/create/bookmarklet/?url=<?php esc_url(the_permalink());?>&amp;is_video=false&amp;description=<?php esc_url(the_title());?>"><i class="ion-logo-pinterest"></i></a>
                </li>
            </ul>
        </div>
